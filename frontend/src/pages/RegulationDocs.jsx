...
export default function RegulationDocs() {
  ...
  const documentGroups = [
    ...
    },
    {
      ...
      documents: [
        {
          title: 'Постановление Правительства КО №254/210 «Об утверждении Программы капитального ремонта общего имущества многоквартирных домов в Республике Дагестан»',
          shortTitle: 'ПП КО №254/210 от 21.03.2014',
          year: 2014,
          relevance: 'План капремонта по годам',
          topics: ['Адреса домов', 'Сроки выполнения'],
          links: [
            { title: 'Фонд капремонта РД', url: '#' }
          ]
        },
        {
          title: 'Постановление Правительства РД «О внесении изменений в Положение об установлении размеров платы в целях формирования и использования фонда капитального ремонта»',
