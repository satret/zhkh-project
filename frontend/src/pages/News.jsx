  ...
  const newsItems = [
    {
      id: 1,
      date: '20 марта 2026',
      title: 'В Кирове повысили тарифы на отопление на 5.2% с 1 апреля',
      excerpt: 'Решение принято региональной энергетической комиссией. Новые тарифы начнут применяться с начала нового отопительного сезона.',
      category: 'tariffs',
      importance: 'high',
      image: '📈'
    },
    {
      id: 2,
      date: '18 марта 2026',
      title: 'ГЖИ Кировской области провела проверку 50 управляющих компаний',
      excerpt: 'Выявлены множественные нарушения в расчетах ОДН. Выданы предписания на устранение в течение 30 дней.',
      category: 'control',
      importance: 'medium',
      image: '🔍'
    },
    ...
    },
    {
      ...
      excerpt: 'В Кировском областном суде рассмотрено дело об избыточном начислении ОДН. Суд обязал УК провести перерасчет на сумму 2.3 млн рублей.',
      category: 'legal',
      importance: 'high',
      image: '⚖️'
    },
    ...
    },
    {
      ...
      title: 'Опрос: как жители Кирова оценивают качество услуг ЖКХ',
    ...
    <section className="page-section">
      <div className="section-inner">
        <div className="page-header">
          <h1>Новости ЖКХ</h1>
          <p className="page-subtitle">Последние новости в сфере жилищно-коммунального хозяйства, отранжированные по важности</p>
        </div>
